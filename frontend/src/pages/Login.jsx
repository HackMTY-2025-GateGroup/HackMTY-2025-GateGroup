...
const Login = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      // Pass name to backend register endpoint
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-secondary via-background to-background p-4">
